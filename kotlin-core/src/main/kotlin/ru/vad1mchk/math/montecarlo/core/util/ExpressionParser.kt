...
object ExpressionParser {
    /**
     * Parses the expression string with the specified variables and
     * returns an expression as a result.
     *
     * @param expressionString String to extract the expressions from.
     * @param variables Names of the variables.
     * @return An expression which you can apply to one or more
     *     arguments.
     * @throws InvalidExpressionException if the expression contains
