...
/**
 * Object that provides a more convenient way to interact with [SecureRandom], which generates cryptographically strong
 * randoms.
 */
object BetterRandom {
    ...
    /**
     * Generates a random int value uniformly distributed between [left] and [right].
    ...
    /**
     * Generates a random double value uniformly distributed between [left] (inclusive) and [right] (exclusive).
     * @param left Min value to generate.
     * @param right Max value to generate.
